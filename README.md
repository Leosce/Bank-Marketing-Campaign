...
6. **Compared Evaluations**: Visually Compared between all of the models' evaluations to give more insight about how different models evaluate differently. also compared between train and test evaluation for each and every model to check for underfitting and overfitting models
